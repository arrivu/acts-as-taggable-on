= ActsAsTaggableOn(multitenant)

Modified for adding multitenacy ,only some methods only support for multitenacy.
before using the method please verify the method has accound_id passed in.
